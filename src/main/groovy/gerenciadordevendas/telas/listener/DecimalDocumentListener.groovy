...
class DecimalDocumentListener implements DocumentListener {
    ...
    DecimalDocumentListener(JTextField txtCustoTotal) {
        this.textField = txtCustoTotal;
    }
    
    DecimalDocumentListener(JTextField txtCustoTotal, DocumentAtualizavel da) {
        this.textField = txtCustoTotal;
        this.da = da;
    }
    ...
    void inicializa() {
        textField.addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                textField.getDocument().addDocumentListener(DecimalDocumentListener.this);
                textField.selectAll();
            }

            @Override
            public void focusLost(FocusEvent e) {
                textField.getDocument().removeDocumentListener(DecimalDocumentListener.this);
            }
        });
    }
