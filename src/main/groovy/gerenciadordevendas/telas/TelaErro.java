/*
 * GerenciadorDeVendas: TelaErro.java
 * Enconding: UTF-8
 * Data de criação: 03/05/2019 13:50:17
 */
...
public class TelaErro extends javax.swing.JDialog {
    ...
    public TelaErro(Throwable erro) {
        super(null, Dialog.DEFAULT_MODALITY_TYPE);
        Logger.getLogger(TelaErro.class.getName()).log(Level.SEVERE, null, erro);
        initComponents();
        final ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try (PrintStream ps = new PrintStream(baos, true, "UTF-8")) {
            erro.printStackTrace(ps);
        } catch (UnsupportedEncodingException ex1) {
            Logger.getLogger(TelaErro.class.getName()).log(Level.SEVERE, null, ex1);
        }
