/*
 * GerenciadorDeVendas: CloseableTabbedPaneTest2.java
 * Enconding: UTF-8
 * Data de criação: 26/02/2018 17:35:22
 */
...
class CloseableTabbedPaneGlassPane extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < tabbedPane.getTabCount(); i++) {
            ...
            button.setForeground(buttonRect.contains(pt) ? Color.BLACK : Color.LIGHT_GRAY);
